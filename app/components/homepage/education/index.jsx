...
import AnimationLottie from "../../lottiehelper/lottie-animation";
import GlowCard from "../../lottiehelper/glow-card";
import lottieFile from '/public/lottie/development.json';

function Education() {
  return (
    <div id="education" className="relative z-50 border-t my-12 lg:my-24 border-[#575757]">
      <Image
        src="/sectionN1.svg"
        alt="Hero"
        width={1572}
      ...
      <div className="flex justify-center -translate-y-[1px]">
        <div className="w-3/4">
          <div className="h-[1px] bg-gradient-to-r from-transparent via-[#616161] to-transparent  w-full" />
        </div>
      </div>
